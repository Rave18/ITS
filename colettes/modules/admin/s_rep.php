          ...
          <div class="card">
              <div class="card-header">
                  ...
                  <div class="form-inline"><br>
                    <select class="form-control form-control-sm" name = "br" onchange = "b_sales(0)">
                    ...
                    &nbsp;&nbsp;&nbsp;<label>Fr:&nbsp;&nbsp;</label><input onkeyup = "b_sales(0)" type = "date" class="form-control form-control-sm" name = "frd" value="<?php echo date("Y-m-d", strtotime($_SESSION['frd']));?>">
                    &nbsp;&nbsp;&nbsp;<label>To:&nbsp;&nbsp;</label><input onkeyup = "b_sales(0)" type = "date" class="form-control form-control-sm" name = "tod" value="<?php echo date("Y-m-d", strtotime($_SESSION['tod']));?>">
                    &nbsp;&nbsp;&nbsp;<a href = "admin/print?rep=sales&print" class="btn btn-sm btn-danger"> Print </a>
                  </div>
              </div>
              <div class="card-body" id = "reportg">
                  <table class="table" align="center" id = "b_salesx">
                    ...
                    <tbody align="center">
                      <?php                        
                        $prod = "SELECT *,sum(total) as s_tot, sum(qty) as q_tot FROM sales as a left join products as b on a.product_id = b.product_id left join branches as c on a.branch_id = c.branch_id where temp = 0 and a.dttm between '" . $_SESSION['frd'] . " 00:00:00' and '" . $_SESSION['tod'] . " 23:59:59' group by a.product_id, a.branch_id";
